...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Verbinden mit dem LIULIHUAYUE-Netzwerk …"),
        ...
        ("install_tip", "Aufgrund der Benutzerkontensteuerung (UAC) kann LIULIHUAYUE in manchen Fällen nicht ordnungsgemäß funktionieren. Um die Benutzerkontensteuerung zu umgehen, klicken Sie bitte auf die Schaltfläche unten und installieren LIULIHUAYUE auf dem System."),
        ...
        ("config_acc", "Um Ihren PC aus der Ferne zu steuern, müssen Sie LIULIHUAYUE Zugriffsrechte erteilen."),
        ("config_screen", "Um aus der Ferne auf Ihren PC zugreifen zu können, müssen Sie LIULIHUAYUE die Berechtigung \"Bildschirmaufnahme\" erteilen."),
        ...
        ("android_input_permission_tip1", "Damit ein entferntes Gerät Ihr Android-Gerät steuern kann, müssen Sie LIULIHUAYUE erlauben, den Dienst \"Barrierefreiheit\" zu verwenden."),
        ("android_input_permission_tip2", "Bitte gehen Sie zur nächsten Systemeinstellungsseite, suchen Sie \"Installierte Dienste\" und schalten Sie den Dienst \"LIULIHUAYUE Input\" ein."),
        ...
        ("Language", "Sprache"),
        ("Keep LIULIHUAYUE background service", "LIULIHUAYUE im Hintergrund ausführen"),
        ...
        ("Show LIULIHUAYUE", "LIULIHUAYUE anzeigen"),
        ("This PC", "Dieser PC"),
        ("or", "oder"),
        ...
        ("config_input", "Um den entfernten Desktop mit der Tastatur steuern zu können, müssen Sie LIULIHUAYUE die Berechtigung \"Eingabeüberwachung\" erteilen."),
        ("config_microphone", "Um aus der Ferne sprechen zu können, müssen Sie LIULIHUAYUE die Berechtigung \"Audio aufzeichnen\" erteilen."),
        ...
        ("still_click_uac_tip", "Der entfernte Benutzer muss immer noch im UAC-Fenster von LIULIHUAYUE auf \"Ja\" klicken."),
        ...
        ("verify_rustdesk_password_tip", "LIULIHUAYUE-Passwort bestätigen"),
        ...
        ("scam_text1", "Wenn Sie mit jemandem telefonieren, den Sie NICHT KENNEN, dem Sie NICHT VERTRAUEN und der Sie gebeten hat, LIULIHUAYUE zu benutzen und den Dienst zu starten, fahren Sie nicht fort und legen Sie sofort auf."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Bitte aktualisieren Sie LIULIHUAYUE Server Pro auf die Version {} oder neuer!"),
        ...
        ("selinux_tip", "SELinux ist auf Ihrem Gerät aktiviert, was dazu führen kann, dass LIULIHUAYUE als kontrollierte Seite nicht richtig läuft."),
        ...
        ("powered_by_me", "Unterstützt von LIULIHUAYUE"),
        ("outgoing_only_desk_tip", "Dies ist eine benutzerdefinierte Ausgabe von LIULIHUAYUE.\nSie können eine Verbindung zu anderen Geräten herstellen, aber andere Geräte können keine Verbindung zu Ihrem Gerät herstellen."),
        ("preset_password_warning", "Dies ist eine benutzerdefinierte Ausgabe von LIULIHUAYUE mit einem voreingestellten Passwort. Jeder, der dieses Passwort kennt, kann die volle Kontrolle über Ihr Gerät erlangen. Wenn Sie dies nicht beabsichtigen, deinstallieren Sie diese Software bitte umgehend."),
        ...
        ("allow-only-conn-window-open-tip", "Verbindung nur zulassen, wenn das LIULIHUAYUE-Fenster geöffnet ist"),
        ...
        ("floating_window_tip", "Es hilft dabei, LIULIHUAYUE im Hintergrund auszuführen."),
        ...
        ("About LIULIHUAYUE", "Über LIULIHUAYUE"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Bitte aktualisieren Sie den LIULIHUAYUE-Client auf der Remote-Seite auf Version {} oder neuer!"),
