...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till GuLingTong..."),
        ...
        ("install_tip", "På grund av UAC, kan inte GuLingTong fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera GuLingTong på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge GuLingTong \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge GuLingTong \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [GuLingTong Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep GuLingTong background service", "Behåll GuLingTong i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa GuLingTong programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show GuLingTong", "Visa GuLingTong"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
