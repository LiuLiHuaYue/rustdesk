...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till LIULIHUAYUE..."),
        ...
        ("install_tip", "På grund av UAC, kan inte LIULIHUAYUE fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera LIULIHUAYUE på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge LIULIHUAYUE \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge LIULIHUAYUE \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [LIULIHUAYUE Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep LIULIHUAYUE background service", "Behåll LIULIHUAYUE i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa LIULIHUAYUE programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show LIULIHUAYUE", "Visa LIULIHUAYUE"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
