...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("OS Password", "OS 비밀번호"),
        ("install_tip", "UAC로 인해 원격 연결 시 일부 기능이 제한될 수 있습니다. 이를 방지하려면 LIULIHUAYUE를 설치하세요."),
        ("Click to upgrade", "업그레이드"),
        ("Click to download", "다운로드"),
        ("Click to update", "업데이트"),
        ("Configure", "구성"),
        ("config_acc", "내 데스크탑을 원격제어하기 전에, LIULIHUAYUE에게 \"Accessibility (접근성)\" 권한을 부여해야 합니다."),
        ("config_screen", "내 데스크탑을 원격제어하기 전에, LIULIHUAYUE에게 \"Screen Recording (화면 녹화)\" 권한을 부여해야 합니다."),
        ("Installing ...", "설치 중..."),
        ("Install", "설치하기"),
        ("Installation", "설치"),
        ...
        ("android_input_permission_tip1", "원격지로서 마우스나 터치를 통해 Android 장치를 제어하려면 LIULIHUAYUE에서 \"Accessibility (접근성)\" 서비스 사용을 허용해야 합니다."),
        ("android_input_permission_tip2", "시스템 설정 페이지로 이동하여 [설치된 서비스]에서 [LIULIHUAYUE Input] 서비스를 켜십시오."),
        ...
        ("Turned off", "종료됨"),
        ("Language", "언어"),
        ("Keep LIULIHUAYUE background service", "LIULIHUAYUE 백그라운드 서비스로 유지하기"),
        ("Ignore Battery Optimizations", "배터리 최적화 무시하기"),
        ("android_open_battery_optimizations_tip", "해당 기능을 비활성화하려면 LIULIHUAYUE 응용 프로그램 설정 페이지로 이동하여 [배터리]에서 [제한 없음] 선택을 해제하십시오."),
        ...
        ("config_input", "키보드를 통해 원격 데스크톱을 제어할 수 있으려면 LIULIHUAYUE의 \"입력 모니터링\" 권한을 부여해 주세요"),
        ("config_microphone", "마이크를 통한 오디오 전송을 지원하려면 LIULIHUAYUE에 \"녹음\" 권한을 부여해 주세요"),
        ...
        ("still_click_uac_tip", "통제된 사용자는 여전히 LIULIHUAYUE를 실행하는 UAC 창에서 확인을 클릭해야 합니다"),
        ...
        ("scam_text1", "모르는 사람과 통화 중이고 그들이 LIULIHUAYUE를 사용하여 서비스를 시작하라고 요청하는 경우, 계속하지 말고 즉시 전화를 끊으세요"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "LIULIHUAYUE Server Pro를 {} 버전 이상으로 업그레이드하십시오!"),
        ...
        ("selinux_tip", "SELinux를 활성화하면 LIULIHUAYUE가 호스트로 제대로 실행되지 않을 수 있습니다"),
        ("Change view", "보기 변경"),
        ("Big tiles", "큰 타일"),
        ("Small tiles", "작은 타일"),
        ("List", "리스트"),
        ...
        ("allow-only-conn-window-open-tip", "LIULIHUAYUE 창이 열려 있는 경우에만 연결 허용"),
        ...
        ("floating_window_tip", "LIULIHUAYUE 백그라운드 서비스를 유지하는 것이 좋습니다."),
        ...
        ("About LIULIHUAYUE", "LIULIHUAYUE 대하여"),
        ...
        ("View camera", "카메라 보기"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "원격 측의 LIULIHUAYUE 클라이언트를 {} 버전 이상으로 업그레이드하십시오!"),
