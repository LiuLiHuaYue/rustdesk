...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "LIULIHUAYUE sarera konektatzen..."),
        ...
        ("install_tip", "Erabiltzaile Kontuen Kontrolarengatik, LIULIHUAYUE ezin du ondo funtzionatu urruneko mahaigainean. EKK saihesteko, mesedez, egin klik azpiko botoian LIULIHUAYUE sistema mailan instalatzeko."),
        ...
        ("config_acc", "Zure mahaigaina urrunetik kontrolatzeko, LIULIHUAYUE-i \"Irisgarritasuna\" baimenak eman behar dituzu."),
        ("config_screen", "Zure mahaigaina kanpotik kontrolatzeko, LIULIHUAYUE-i \"Pantaila grabatu\" baimena eman behar duzu."),
        ...
        ("android_input_permission_tip1", "Urruneko gailu batek zure Android gailua saguaren edo ukipenaren bidez kontrolatzeko, LIULIHUAYUE \"Irisgarritasuna\" zerbitzua erabiltzeko baimena eman behar diozu."),
        ("android_input_permission_tip2", "Joan hurrengo irekiko den sistemaren konfigurazio orrira, bilatu eta sartu [Instalatutako zerbitzuak], aktibatu [LIULIHUAYUE Input] zerbitzua."),
        ...
        ("Turned off", "Itzalita"),
        ("Language", "Hizkuntza"),
        ("Keep LIULIHUAYUE background service", "Mantendu LIULIHUAYUE atzeko planoko zerbitzu bezala"),
        ("Ignore Battery Optimizations", "Ezikusi bateria optimizazioak"),
        ("android_open_battery_optimizations_tip", "Ezaugarri hau desgaitu nahi baduzu, joan zaitez LIULIHUAYUE aplikazioaren ezarpen orrira, bilatu eta saltu [Bateria] orrira eta kendu [Mugarik gabe]"),
        ...
        ("Show LIULIHUAYUE", "Erakutsi LIULIHUAYUE"),
        ("This PC", "PC hau"),
        ("or", "edo"),
        ...
        ("config_input", "Urruneko mahaigaina teklatuaren bidez kontrolatzeko, LIULIHUAYUE-i \"Sarrera monitorizazioa\" baimena eman behar diozu."),
        ("config_microphone", "Urrunetik hitz egin ahal izateko, LIULIHUAYUEi-i \"Grabatu audioa\" baimena eman behar diozu."),
        ...
        ("still_click_uac_tip", "Oraindik beharrezkoa da urruneko erabiltzaileak Ondo botoiari klik egitea exekutatzen ari den LIULIHUAYUE UAC leihoan"),
        ...
        ("verify_rustdesk_password_tip", "Berretsi LIULIHUAYUE pasahitza"),
        ...
        ("scam_text1", "Ezagutzen eta fidatzen EZ duzun norbaitekin telefonoz bazaude eta LIULIHUAYUE erabiltzeko eta zerbitzua abiarazteko eskatu badizute, ez ezazu egin eta eskegi berehala."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Mesedez, bertsio-berritu LIULIHUAYUE Server Pro {} bertsiora edo berriago batera!"),
        ...
        ("selinux_tip", "SELinux zure gailuan gaituta dago. Honek LIULIHUAYUE kontrolatutako alde gisa dagoenean behar bezala ez exekutatzea ekarri dezake."),
        ...
        ("powered_by_me", "LIULIHUAYUE-ek egina"),
        ...
        ("allow-only-conn-window-open-tip", "Baimendu konexioa LIULIHUAYUE leihoa irekita badago"),
        ...
        ("floating_window_tip", "LIULIHUAYUE atzeko planoko zerbitzua mantentzen laguntzen du"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Mesedez, eguneratu LIULIHUAYUE bezeroa {} bertsiora edo berriagoa urruneko aldean!"),
