...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do HyDeskPro..."),
        ...
        ("install_tip", "Devido ao UAC, o HyDeskPro não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o HyDeskPro no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao HyDeskPro permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao HyDeskPro permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o HyDeskPro use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [HyDeskPro Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep HyDeskPro background service", "Manter o serviço do HyDeskPro executando em segundo plano"),
        ...
        ("Show HyDeskPro", "Exibir HyDeskPro"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do HyDeskPro."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do HyDeskPro."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do HyDeskPro."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do HyDeskPro"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o HyDeskPro e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o HyDeskPro Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o HyDeskPro funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por HyDeskPro"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do HyDeskPro estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço HyDeskPro em segundo plano"),
        ...
        ("About HyDeskPro", "Sobre HyDeskPro"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente HyDeskPro para a versão {} ou superior no lado remoto."),
