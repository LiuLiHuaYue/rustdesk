...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "GuLingTongi võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa GuLingTong mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et GuLingTong oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Click to download", "Vajuta allalaadimiseks"),
        ("Click to update", "Vajuta uuendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb GuLingTongile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb GuLingTongile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma GuLingTongile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [GuLingTong Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep GuLingTong background service", "Säilita GuLingTongi taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele GuLingTongi rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show GuLingTong", "Kuva GuLingTong"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma GuLingTongile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma GuLingTongile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud GuLingTongi kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita GuLingTongi parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul GuLingTongi kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda GuLingTong Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib GuLingTongil takistada juhitud poolel toimimist."),
        ...
        ("powered_by_me", "Põhineb GuLingTongil"),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui GuLingTongi aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada GuLingTongi taustateenust."),
        ...
        ("About GuLingTong", "GuLingTongi teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage GuLingTongi klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
