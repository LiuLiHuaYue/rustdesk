...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na LIULIHUAYUE mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a LIULIHUAYUE ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate LIULIHUAYUE na sustav."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, LIULIHUAYUE-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, LIULIHUAYUE-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti LIULIHUAYUE-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [LIULIHUAYUE Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep LIULIHUAYUE background service", "Zadrži LIULIHUAYUE kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje LIULIHUAYUE aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("Show LIULIHUAYUE", "Prikaži LIULIHUAYUE"),
        ...
        ("config_input", "Za upravljanje udaljenom radnom površinom pomoću tipkovnice, morate dodijeliti LIULIHUAYUEu dopuštenje \"Nadzor unosa\"."),
        ("config_microphone", "Da biste razgovarali na daljinu, morate dopustiti LIULIHUAYUEu \"Snimanje zvuka\"."),
        ...
        ("still_click_uac_tip", "Još uvijek zahtijeva da udaljeni korisnik klikne OK u UAC prozoru pokrenutog LIULIHUAYUEa."),
        ...
        ("verify_rustdesk_password_tip", "Provjera lozinke za LIULIHUAYUE"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete LIULIHUAYUE, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ažurirajte LIULIHUAYUE Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti LIULIHUAYUE da pravilno radi kao upravljana strana."),
        ...
        ("powered_by_me", "Pokreće LIULIHUAYUE"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo ažurirajte LIULIHUAYUE klijent na verziju {} ili noviju na udaljenoj strani!"),
